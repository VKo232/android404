...
//            mEmailView.setError("Account with this email exists");
//            focusView = mEmailView;
//            cancel = true;
//        }
        ...
        if(TextUtils.isEmpty(firstName)) {
            mFirstNameView.setError("field is required");
            focusView = mFirstNameView;
            cancel= true;
        }
        if(TextUtils.isEmpty(lastName)) {
            mLastNameView.setError("field is required");
...
//        try {
//            return communicator.hasCustomerObj(email);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//            Log.d("isEmailDuplicate", "Communicator error");
//            return true;
//        }
//    }
